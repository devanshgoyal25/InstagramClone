        ...
        btnSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(description.isEmpty()){
                    Toast.makeText(getContext(), "Sorry, the post description cannot be empty.", Toast.LENGTH_SHORT).show();
                    return;
                }
        ...
        post.saveInBackground(new SaveCallback() {
            ...
            public void done(ParseException e) {
                if (e!=null){
                    ...
                    Toast.makeText(getContext(), "The post could not be saved", Toast.LENGTH_SHORT).show();
                }
